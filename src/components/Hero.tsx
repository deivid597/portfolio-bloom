      ...
      <div className="container-narrow relative z-10">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold mb-6 py-4 text-gradient leading-tight"
          >
            {t('hero.name')}
          </motion.h1>
          ...
          >
            ...
            <a
              href="https://www.linkedin.com/in/david-solano-319337252/"
              target="_blank"
